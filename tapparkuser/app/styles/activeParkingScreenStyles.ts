...
export const getActiveParkingScreenStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  ticketContainer: {
    ...
    padding: isSmallScreen ? getResponsivePadding(12) : isTablet ? getResponsivePadding(30) : getResponsivePadding(20),
    paddingBottom: isSmallScreen ? getResponsivePadding(20) : isTablet ? getResponsivePadding(40) : getResponsivePadding(30),
    borderWidth: 1,
    borderColor: colors.primary,
    flex: 1,
    minHeight: isSmallScreen ? getResponsiveSize(500) : isTablet ? getResponsiveSize(750) : getResponsiveSize(650),
    maxWidth: '100%',
    width: '100%',
  ...
  qrContainer: {
    backgroundColor: colors.backgroundSecondary,
    padding: isSmallScreen ? getResponsivePadding(12) : isTablet ? getResponsivePadding(25) : getResponsivePadding(20),
    borderRadius: getResponsiveSize(8),
    marginTop: isSmallScreen ? getResponsiveMargin(10) : isTablet ? getResponsiveMargin(30) : getResponsiveMargin(20),
    marginBottom: isSmallScreen ? getResponsiveMargin(8) : getResponsiveMargin(12),
    borderWidth: 1,
    borderColor: colors.border,
    alignItems: 'center',
    justifyContent: 'center',
    minHeight: isSmallScreen ? getResponsiveSize(180) : isTablet ? getResponsiveSize(320) : getResponsiveSize(250),
    maxHeight: isSmallScreen ? getResponsiveSize(220) : isTablet ? getResponsiveSize(360) : getResponsiveSize(280),
  },
  qrInstruction: {
    fontSize: isSmallScreen ? getResponsiveFontSize(12) : isTablet ? getResponsiveFontSize(18) : getResponsiveFontSize(16),
    fontWeight: 'bold',
    color: colors.primary,
    textAlign: 'center',
    paddingHorizontal: isSmallScreen ? getResponsivePadding(8) : getResponsivePadding(16),
    lineHeight: isSmallScreen ? getResponsiveFontSize(16) : isTablet ? getResponsiveFontSize(24) : getResponsiveFontSize(20),
  },
  separator: {
    height: 1,
    borderTopWidth: 1,
    ...
    borderStyle: 'dashed',
    marginVertical: isSmallScreen ? getResponsiveMargin(8) : isTablet ? getResponsiveMargin(15) : getResponsiveMargin(12),
  },
  detailsContainer: {
    flexDirection: isSmallScreen ? 'column' : 'row',
    justifyContent: 'space-between',
    flexShrink: 0,
    gap: isSmallScreen ? getResponsiveMargin(12) : getResponsiveMargin(16),
  },
  detailsColumn: {
    flex: 1,
    paddingHorizontal: isSmallScreen ? getResponsivePadding(4) : isTablet ? getResponsivePadding(15) : getResponsivePadding(10),
    justifyContent: 'flex-start',
    minWidth: isSmallScreen ? '100%' : '48%',
  },
  detailRow: {
    marginBottom: isSmallScreen ? getResponsiveMargin(10) : isTablet ? getResponsiveMargin(16) : getResponsiveMargin(12),
    flexShrink: 0,
    justifyContent: 'center',
    minHeight: isSmallScreen ? getResponsiveSize(40) : isTablet ? getResponsiveSize(50) : getResponsiveSize(45),
  },
  detailLabel: {
    fontSize: isSmallScreen ? getResponsiveFontSize(11) : isTablet ? getResponsiveFontSize(16) : getResponsiveFontSize(14),
    fontWeight: 'bold',
    color: colors.primary,
    marginBottom: isSmallScreen ? getResponsiveMargin(2) : getResponsiveMargin(4),
    textAlign: 'center',
    lineHeight: isSmallScreen ? getResponsiveFontSize(14) : isTablet ? getResponsiveFontSize(20) : getResponsiveFontSize(18),
  },
  detailValue: {
    fontSize: isSmallScreen ? getResponsiveFontSize(13) : isTablet ? getResponsiveFontSize(18) : getResponsiveFontSize(16),
    color: colors.textSecondary,
    fontWeight: '500',
    textAlign: 'center',
    flexShrink: 1,
    textAlignVertical: 'center',
    lineHeight: isSmallScreen ? getResponsiveFontSize(18) : isTablet ? getResponsiveFontSize(24) : getResponsiveFontSize(22),
  },
  ...
  svgContainer: {
    ...
    padding: getResponsivePadding(20),
    paddingBottom: getResponsivePadding(30),
    minHeight: isSmallScreen ? getResponsiveSize(450) : isTablet ? getResponsiveSize(650) : getResponsiveSize(550),
    maxHeight: isSmallScreen ? getResponsiveSize(600) : isTablet ? getResponsiveSize(800) : getResponsiveSize(700),
    overflow: 'hidden',
  },
  layoutHeader: {
    flexDirection: 'row',
